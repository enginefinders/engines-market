    ...
    <Section className="bg-[#f5f5f5] px-2 py-7 sm:py-8 lg:py-10">
      ...
      <Container className="max-w-[1400px]">
        <div className="mx-auto max-w-190 text-center">
          ...
          {/* Flex column ensures the info text stays below the heading and pushes content down */}
          <div className="mt-4 flex flex-col items-center">
            <h2 className="font-['Manrope'] text-[28px] font-bold leading-[1.12] text-[#0d1b2e] sm:text-[30px] lg:text-[32px]">
              ...
              <button
                ...
                className="inline-flex h-5 w-5 flex-none items-center justify-center rounded-full text-[11px] border border-black font-bold text-black transition focus:outline-none focus:ring-2 focus:ring-[#2d7a3a] focus:ring-offset-2 align-middle relative -top-0.5 ml-1"
            ...
            {/* Normal flow text: takes up space and pushes the table downwards when open */}
            {infoOpen && (
              <p className="mt-3 max-w-[280px] md:max-w-md text-center text-[13px] leading-[1.6] text-[#5a6478]">
