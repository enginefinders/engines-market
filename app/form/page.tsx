        ...
        <div className="min-h-screen bg-gray-50 py-8 px-4 md:px-8">
            <div className="max-w-3xl mx-auto">
                <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 md:p-8">
                                ...
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        onChange={(event) => {
                                            ...
                                            setFormData((prev) => ({
                                                ...prev,
                                                registrationNumber: event.currentTarget.value.toUpperCase(),
                                            }));
                                        }}
                    ...
                    <button
                        type="submit"
                        className="w-full py-4 px-6 bg-[#15803d] text-white text-lg font-bold rounded-lg hover:bg-green-700 transition uppercase tracking-wide shadow-md"
                    >
                        SEND ME PRICE QUOTE
                    </button>
                </form>
